...
class ZshotDaemon : public QObject
{
    Q_OBJECT
public:
    static void start();
    static ZshotDaemon* instance();
    ...
    void sendTrayNotification(
      const QString& text,
      const QString& title = QStringLiteral("Zshot Info"),
...
private:
    ...
    static ZshotDaemon* m_instance;

#if !(defined(Q_OS_MACOS) || defined(Q_OS_WIN))
    friend class ZshotDBusAdapter;
#endif
};
